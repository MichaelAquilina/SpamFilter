...
Unfortunately, choosing a ideal \begin{math}\alpha \end{math} and \begin{math} \beta \end{math} is a somewhat tedious process of trial and error. \todo{Uwe you could start writing about feature selection here}
...
\todo{Frequency Weighting and TFIF Weighting comparison}