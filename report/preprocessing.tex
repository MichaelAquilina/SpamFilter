...
\todo{State how many words we have saved and which runtime we achieved}
...
\todo{State that $\alpha = 0$ leads to the best result but we can dramtically decrease the dimensionality with slight increases of the threshold}
